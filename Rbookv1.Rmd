...
%>% 	filter(iris, Sepal.Width == 3) 	iris %>% filter(Sepal.Width == 3)
%<>% 	iris <- filter(iris, Sepal.Width == 3) 	iris %<>% filter(Sepal.Width == 3)
%$% 	cor(iris$Petal.Length, iris$Petal.Width) 	iris %$% cor(Petal.Length, Petal.Width)
%T>% 	iris; plot(iris) 	iris %T>% plot()
